    ...
    <nav aria-label="Page navigation example" class="d-flex justify-content-center mt-3">
        <ul class="pagination">
            ...
            <c:forEach var="page" begin="0" end="${products.totalPages-1}">
                <li class="page-item"><a class="page-link ${products.number==page?'active':''}" href="/?page=${page}">${page+1}</a></li>
            </c:forEach>
            <li class="page-item">
                <a class="page-link" href="/?page=${products.totalPages-1}" aria-label="Next">
