        ...
        <div class="row w-100">
            <div class="col-2">
                ...
                <div class="nav flex-column nav-tabs text-center" id="v-tabs-tab" role="tablist"
                    ...
                    <a data-mdb-tab-init class="nav-link" id="v-tabs-messages-tab" href="#v-tabs-messages" role="tab"
                        aria-controls="v-tabs-messages" aria-selected="false">Old Order</a>
                    <a data-mdb-tab-init class="nav-link" id="v-tabs-messages-tab" href="#v-tabs-cancel" role="tab"
                        ...
                        Profile</a>
                    <a data-mdb-tab-init class="nav-link" id="v-tabs-messages-tab" href="#v-tabs-complete" role="tab"
                        aria-controls="v-tabs-messages" aria-selected="false">Complete Order</a>
                </div>
                <!-- Tab navs -->
            </div>
            ...
            <div class="col-9">
                ...
                <div class="tab-content" id="v-tabs-tabContent">
                                    ...
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <button class="btn btn-danger btn-sm">Cancel
                                                Order</button>
                                            <button class="btn btn-primary btn-sm">Track
                                                Order</button>
                                        </div>
                                    </div>
                                    <div class="card-body">
                    ...
                    <div class="tab-pane fade" id="v-tabs-cancel" role="tabpanel" aria-labelledby="v-tabs-messages-tab">
                        <div class="container">
                        ...
                        <div class="container">
                            <form action="/profile/change-password" method="post">
                                ...
                                <div data-mdb-input-init class="form-outline mb-4">
                                    <input type="password" name="oldPassword" id="form3Example3" class="form-control" />
